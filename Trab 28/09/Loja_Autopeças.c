...
int main(){
    ...
    int i, j, mat[11][61], identificacao, produto = 1, quantidade_produtos, total_vendas = 0, maior_vendedor = 0, produto_menos_vendido = 50, vet_produtos[61], vet_vendedor[11], maior_venda = 0;
    float vet_comissao[11], comissao = 0, valor = 1, valor_compra = 0, vet[61], lucro_vendedor1 = 0, lucro_vendedor2 = 0, lucro_vendedor3 = 0, lucro_vendedor4 = 0, lucro_vendedor5 = 0, lucro_vendedor6 = 0, lucro_vendedor7 = 0, lucro_vendedor8 = 0, lucro_vendedor9 = 0, lucro_vendedor10 = 0;
    ...
    do{
        ...
        mat[identificacao - 1][produto - 1] += quantidade_produtos;

        vet_produtos[produto - 1] = quantidade_produtos;

        valor_compra = valor_compra + quantidade_produtos * vet[produto - 1];

        vet_vendedor[identificacao - 1] = quantidade_produtos * vet[produto - 1];
        ...
        printf("\n\nO LUCRO TOTAL OBTIDO (em reais) FOI DE R$%.2d", total_vendas);   
